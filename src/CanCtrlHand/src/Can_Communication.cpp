...
namespace AIMOcommunicate
{
    ...
    void Can_Communication::AllSendDataDeal_16DofHand(void)
    {
        ...
        Hand_16Dof_Send.thumb.yaw_angle = RightHand_Send.joint1_rotation;
        ...
        Hand_16Dof_Send.thumb.roll_angle = RightHand_Send.joint_angle_2;
        Hand_16Dof_Send.index.roll_angle = RightHand_Send.joint_angle_2;
        Hand_16Dof_Send.middle.roll_angle = RightHand_Send.joint_angle_2;
        Hand_16Dof_Send.ring.roll_angle = RightHand_Send.joint_angle_2;
        Hand_16Dof_Send.little.roll_angle = RightHand_Send.joint_angle_2;
